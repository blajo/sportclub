  ...
  en: {
    translation: {
      ...
      map: {
        ...
        Tracks: 'Running and skiing tracks',
        TrackName: 'Track name',
        TrackCenter: 'Track center name',
        Description: 'Description',
        EditSvg: 'Edit SVG',
        ChangeSvg: 'Change SVG',
        dimond: 'Diamond',
        dimondUpperLeftWhite: 'Diamond upper left white',
        dimondRightWhite: 'Diamond right white',
        dimondLowerRightWhite: 'Diamond lower right white',
        dimondLeftWhite: 'Diamond left white',
        cirkle: 'Circle',
        cirkleUpperLeftWhite: 'Circle upper left white',
      ...
      results: {
        ...
        parentOrganisationIdsNational: 'Also show national events where organisaion/club belong to',
        parentOrganisationIdsDistrict: 'Also show regional events where club belong to',
        organisationIdsNearbyAndClub: 'Also show local and club events for the clubs',
        includeEventorIds: 'Also include eventIds from eventor',
  ...
  sv: {
    translation: {
      ...
      map: {
        ...
        Tracks: 'Löp- och skidspår',
        TrackName: 'Spårets namn',
        TrackCenter: 'Spårcentral',
        Description: 'Beskrivning',
        EditSvg: 'Redigera SVG',
        ChangeSvg: 'Byt SVG',
        dimond: 'Diamant',
        dimondUpperLeftWhite: 'Diamant, övre vänster vit',
        dimondRightWhite: 'Diamant, höger vit',
        dimondLowerRightWhite: 'Diamant, nedre höger vit',
        dimondLeftWhite: 'Diamant, vänster vit',
        cirkle: 'Cirkel',
        cirkleUpperLeftWhite: 'Cirkel, övre vänster vit',
      ...
      results: {
        ...
        parentOrganisationIdsNational: 'Visa även nationella tävlingar där orginisation/klubben tillhör',
        parentOrganisationIdsDistrict: 'Visa även distriktstävlingar där klubben tillhör',
        organisationIdsNearbyAndClub: 'Visa även när- och klubbtävlingar för klubbarna',
        includeEventorIds: 'Visa även "eventId"-s från eventor',
